/*
** active_passive.c for active_passive in /home/tekm/tek2/PSU_2016_myftp
** 
** Made by leroy_0
** Login   <maxime.leroy@epitech.eu>
** 
** Started on  Thu May 18 19:45:55 2017 leroy_0
** Last update Thu May 18 19:45:55 2017 leroy_0
*/

#include 	"myftp.h"

bool 					set_pasv(struct s_server *server,
	struct s_client *client, struct s_server *tmp_serv)
{
	socklen_t 			size;
	char 				*msg;
	...
	struct s_client *client)
{
	...
	return (set_pasv(server, client, tmp_serv));
}
